...
const DonationsPage = () => {
  ...
  const donations = [
    {
      ...
      description: "Emergency medical supplies and food kits for flood-affected regions in Ethiopia.",
      category: "Emergency",
      image: ERCS,
    ...
    },
    {
      ...
      description: "Providing emergency medical supplies and food kits for flood-affected communities.",
      category: "Medical",
      image: meseret,
    ...
    },
    {
      ...
      description: "Education supplies and nutrition support for children in drought-affected areas.",
      category: "Education",
      image: save,
    ...
    }, 
    {
        ...
        description: "The purpose of Mekedonia Homes is to support the elderly and people with Mental disabilities.",
        category: "Clothing",
        image: mekedonia,
      ...
      },
    {
      ...
      description: "Clothes for women and children affected by displacement in rural Ethiopia.",
      category: "Clothing",
      image: meseret,
      location: "Dire Dawa",
      urgency: "high"
    },
    {
      ...
      description: "Emergency food supplies for drought-affected communities in Oromia region.",
      category: "Food",
      image: ERCS,
  ...
  const filteredDonations = donations.filter(donation => {
    const matchesSearch = donation.organization.toLowerCase().includes(searchTerm.toLowerCase()) || 
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
      ...
      <div className="bg-gradient-to-r from-green-700 to-green-600 rounded-xl p-8 mb-8 text-white">
        <h1 className="text-3xl md:text-4xl font-bold mb-2">Make a Difference Today</h1>
        <p className="text-lg mb-6 max-w-2xl">Join thousands of donors supporting critical causes across Ethiopia</p>
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          ...
          <button className="flex items-center bg-yellow-400 hover:bg-yellow-500 text-green-700 font-medium py-3 px-6 rounded-full transition-all shadow-md hover:shadow-lg">
      ...
      <div className="mb-6 flex justify-between items-center">
        <h2 className="text-xl font-semibold text-gray-800">
          {filteredDonations.length} {filteredDonations.length === 1 ? "Result" : "Results"} Found
        </h2>
        <div className="text-sm text-gray-500">
          Sorted by: <span className="font-medium text-green-700">Most Urgent</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {filteredDonations.length > 0 ? (
          ...
          <div className="col-span-full text-center py-16">
            ...
            <h3 className="text-xl font-medium text-gray-600 mb-2">No matching donations found</h3>
            <p className="text-gray-500 max-w-md mx-auto">
              Try adjusting your search filters or check back later for new donation opportunities.
            </p>
          </div>
        )}
      </div>
