...
const AdminDashboard = () => {
  const { users, pagination, loading, error } = useDashboardUsers(true); // true means fetch all users
    ...
    <AdminLayout>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <p className="text-2xl font-semibold">
            {verificationDistribution['verified'].toLocaleString()}
          </p>
        </div>
        <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <p className="text-2xl font-semibold">
            {verificationDistribution['pending'].toLocaleString()}
          </p>
        </div>
      </div>
